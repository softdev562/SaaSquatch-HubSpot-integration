                                                    ...
                                                    .then((response) => {
                                                        ...
                                                        if (
                                                            ...
                                                            (response.data.hubspotID === '' &&
                                                                ...
                                                                response.data.DeleteContactwhenParticipantDeleted ===
                                                                    false &&
                                                                response.data.PushContactsAsParticipants === false &&
                                                                response.data.PullContactsIntoParticipants === false &&
                                                                response.data.DeleteParticipantWhenContactDeleted ===
                                                                    false &&
    ...
    return (
        <Wrapper className="wrapper">
            <div>
                ...
                <InfoText className="info-text">
                    For more information read our&nbsp;<a href={`https://example.com`}>HubSpot Quickstart Guide.</a>
                </InfoText>
                ...
                <div>
                    {states.showError ? (
                        <ErrorText>Failed to authenticate: User closed the popup window.</ErrorText>
                    ) : (
                        <React.Fragment />
                    )}
                </div>
