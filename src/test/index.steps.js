...
var connection = jest_cucumber_1.loadFeature('features/Disconnect.feature');
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, axios.get(options)];
            case 1:
                response = _a.sent();
                data = response.data;
...
jest_cucumber_1.defineFeature(connection, function (test) {
    ...
    test('Disconnecting Hubspot from integration', function (_a) {
        ...
        and('I have Hubspot access and refresh tokens stored', function () {
            //#todo UPDATE LINE BELOW TO RECIEVE access and refresh token from DB
